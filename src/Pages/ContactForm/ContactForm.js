          ...
          <div className="p-6">
            ...
            <form>
              ...
              <textarea
                name=""
                id=""
                className="block w-full py-16 my-4 p-5 rounded-md focus:ring-blue-500 focus:border-blue-500  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ></textarea>
